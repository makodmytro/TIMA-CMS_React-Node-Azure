...
import { Datagrid, DateField, List, FunctionField, TextField, BooleanField, useTranslate } from 'react-admin';
  ...
  return (
    <>
      <AppBar position="static" color="secondary">
        <Tabs variant="fullWidth" value={0} aria-label="nav tabs example" TabIndicatorProps={{ style: { background: 'white' } }}>
