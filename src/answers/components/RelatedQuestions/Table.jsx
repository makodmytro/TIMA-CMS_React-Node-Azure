...
import { useTranslate, FunctionField, TextField as RATextField } from 'react-admin';
...
const RelatedQuestionsTable = ({ record, onUnlinkClick }) => {
  ...
  return (
    <>
      ...
      <Table>
        <TableHead>
          <TableRow>
            {isThereContext && <TableCell>{translate('resources.questions.fields.context')}</TableCell>}
